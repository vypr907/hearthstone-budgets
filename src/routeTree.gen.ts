...
const AppFixInstitutionLoginsRoute = AppFixInstitutionLoginsRouteImport.update({
  id: '/fix-institution-logins',
  path: '/fix-institution-logins',
  getParentRoute: () => AppRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/app/fix-institution-logins': {
      id: '/app/fix-institution-logins'
      path: '/fix-institution-logins'
      fullPath: '/app/fix-institution-logins'
      preLoaderRoute: typeof AppFixInstitutionLoginsRouteImport
      parentRoute: typeof AppRoute
    }
    '/app/fix-places': {
      id: '/app/fix-places'
