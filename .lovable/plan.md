...
- Docs updated per project rules: `SESSION.md`, `SCHEMA.md`, `ARCHITECTURE.md`, `DECISIONS.md` (new ADRs for deductions, transfers/advances, overdue allocation, balance-affecting fees), `TODO.md`, `ROADMAP.md`.
